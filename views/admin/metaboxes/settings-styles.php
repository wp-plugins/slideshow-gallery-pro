...
<table class="form-table">
	<tbody>
		<tr>
			...
			?>
                <select disabled>
                    <option>Classic </option> <?php _e('Classic', $this -> plugin_name); ?>
                </select>
			<?php } ?>
		...
		<tr>
			...
			<td>
				<label><input <?php echo ($styles['resizeimages2'] == "Y") ? 'checked="checked"' : ''; ?> <?php echo ($resize2); ?> name="styles[resizeimages2]" value="Y" id="styles.resizeimages_Y" /> <?php _e('Yes', $this -> plugin_name); ?></label>
				<label><input <?php echo (empty($styles['resizeimages2']) || $styles['resizeimages2'] == "N") ? 'checked="checked"' : ''; ?>  <?php echo ($resize2); ?> name="styles[resizeimages2]" value="N" id="styles.resizeimages2_N" /> <?php _e('No', $this -> plugin_name); ?></label>
				<span class="howto"><?php _e('Full Edition only. Should images be resized proportionally to fit the height of the slideshow area. ', $this -> plugin_name); ?></span>
			</td>
		</tr>
		<tr>
